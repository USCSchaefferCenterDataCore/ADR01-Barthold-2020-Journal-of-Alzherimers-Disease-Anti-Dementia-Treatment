...
proc sql;
   ...
   %getplans(2015,eseq=1,pref=opt1pde,seq=N)
	 %getplans(2016,eseq=1,pref=opt1pde,seq=N)
   ...
   %sascontents(pdeplan_dts2013,lib=out,contdir=&contentsdir,domeans=Y);
	 %sascontents(pdeplan_dts2014,lib=out,contdir=&contentsdir,domeans=Y);
 	 %sascontents(pdeplan_dts2015,lib=out,contdir=&contentsdir,domeans=Y);
	 %sascontents(pdeplan_dts2016,lib=out,contdir=&contentsdir,domeans=Y);