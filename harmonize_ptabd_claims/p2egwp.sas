...
data _null_;
   ...
   set pln.pln2006 (in=_in06 keep=contract_id plan_id egwp_indicator)
       ...
       pln.pln2015 (in=_in15 keep=contract_id plan_id egwp_indicator)
       pln.pln2016 (in=_in16 keep=contract_id plan_id egwp_indicator)
       end=lastone;
   ...
   else if _in15 then year=2015;
   else if _in16 then year=2016;
