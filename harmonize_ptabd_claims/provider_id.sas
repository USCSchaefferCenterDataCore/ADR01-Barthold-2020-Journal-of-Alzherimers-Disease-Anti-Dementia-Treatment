...
%extractyrs(car,,,
           ...
           codein=,
           idvar=bene_id,claimvar=clm_id,RLvar=line_num,typsfx=L,
           smp=l,clms=,begy=2015,endy=2016);
...
%extractyrs(hha,clm_thru_dt at_physn_npi at_physn_upin
           org_npi_num prvdr_num prvdr_state_cd,
           thru_dt &ptA_hhahos06p,
           codein=,
           idvar=bene_id,claimvar=clm_id,RLvar=,typsfx=C,
