...
// Limit to AD only - change monthssincedx to AD_inc and drop dx dummies

drop if AD_inc==. | year(AD_inc)>year

gen agesq=age^2
gen eoy=mdy(12,31,year)
gen monthssincedx=(eoy-AD_inc)/(365/12)

sum monthssincedx 

list bene_id year ADRDplus_inc monthssincedx if monthssincedx==0

global yvar7 "adrx71"
global yvar90 "adrx902"
global yvar180 "adrx1802"
global yvar270 "adrx2702"
global xvar1 "female age agesq race_db race_dh race_da spec"
global xvar2 "female age agesq race_db race_dh race_da i.hcc4 dual lis i.year i.phyvis4 cc* monthssincedx spec"
...
logit $yvar7 $xvar1, or vce(cluster zip)
	...
	putexcel set "./output/logit_AD.xlsx",sheet(1) modify
...
logit $yvar7 $xvar2, or vce(cluster zip)
	...
	putexcel set "./output/logit_AD.xlsx",sheet(2) modify
...
logit $yvar90 $xvar1, or vce(cluster zip)
	...
	putexcel set "./output/logit_AD.xlsx",sheet(3) modify
...
logit $yvar90 $xvar2, or vce(cluster zip) 
	...
	putexcel set "./output/logit_AD.xlsx",sheet(4) modify
...
logit $yvar180 $xvar1, or vce(cluster zip) 
	...
	putexcel set "./output/logit_AD.xlsx",sheet(5) modify
...
logit $yvar180 $xvar2, or vce(cluster zip) 
	...
	putexcel set "./output/logit_AD.xlsx",sheet(6) modify
...
logit $yvar270 $xvar1, or vce(cluster zip) 
	...
	putexcel set "./output/logit_AD.xlsx",sheet(7) modify
...
logit $yvar270 $xvar2, or vce(cluster zip) 
	...
	putexcel set "./output/logit_AD.xlsx",sheet(8) modify
