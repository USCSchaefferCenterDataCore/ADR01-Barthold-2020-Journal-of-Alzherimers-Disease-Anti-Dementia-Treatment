...
gen monthssincedx=(eoy-ADRDplus_inc)/(365/12)
...
global xvar1 "female age agesq race_db race_dh race_da dx_dad dx_dnadd spec monthssincedx"
...
logit $yvar7 $xvar1, or vce(cluster zip)
	...
	putexcel set "./output/logit_ADRDsymp.xlsx",sheet(1) modify
...
logit $yvar7 $xvar2, or vce(cluster zip)
	...
	putexcel set "./output/logit_ADRDsymp.xlsx",sheet(2) modify
...
logit $yvar90 $xvar1, or vce(cluster zip)
	...
	putexcel set "./output/logit_ADRDsymp.xlsx",sheet(3) modify
...
logit $yvar90 $xvar2, or vce(cluster zip) 
	...
	putexcel set "./output/logit_ADRDsymp.xlsx",sheet(4) modify
...
logit $yvar180 $xvar1, or vce(cluster zip) 
	...
	putexcel set "./output/logit_ADRDsymp.xlsx",sheet(5) modify
...
logit $yvar180 $xvar2, or vce(cluster zip) 
	...
	putexcel set "./output/logit_ADRDsymp.xlsx",sheet(6) modify
...
logit $yvar270 $xvar1, or vce(cluster zip) 
	...
	putexcel set "./output/logit_ADRDsymp.xlsx",sheet(7) modify
...
logit $yvar270 $xvar2, or vce(cluster zip) 
	...
	putexcel set "./output/logit_ADRDsymp.xlsx",sheet(8) modify
