...
* Input: ad_dxprv_&ctyp_2002_2013;
* Output: ;
...
data addrugs.ad_dxprv_&ctyp.2002_&maxyr._npi;
	...
	do until (eof_samp);
		set addrugs.ad_dxprv_&ctyp.&byear._&eyear (where=(bene_id ne "")) end=eof_samp ;
...
proc freq data=addrugs.ad_dxprv_&ctyp.2002_&maxyr._npi;
	%do i=1 %to &max;
...
proc freq data=upin&ctyp._ck;
	...
	table no_npi;
	table match_npi;
	title3 "UPIN but no NPI &ctyp. 2008-2013";
run;
%mend;
