...
* PURPOSE:  Setting up the ADRD incident;

* INPUT: pde_ad_0613, ADinc_0213, ffs_samp_0413;
* OUTPUT: analysis;
...
data &out.;
	set addrugs.symp_dxprv_&typ.2002_&maxyr._npi;
	%do i=1 %to &max;
...
%format(carmrg_,carmrg_w,npilist=rfr_npi1
			  ...
			  prgrpnpi6
			  prgrpnpi7
			  prgrpnpi8,hcfamax=8,hcfamaxminus1=7);
...
data carmrg_;
	set carmrg_w;
	array prfnpi [*] carmrg_prf_npi1-carmrg_prf_npi8;
	array primaryspec [*] primaryspec_carmrg_prf_npi1-primaryspec_carmrg_prf_npi8;
	array anyspec [*] anyspec_carmrg_prf_npi1-anyspec_carmrg_prf_npi8;
	array primarytax [*] primarytax_carmrg_prf_npi1-primarytax_carmrg_prf_npi8;
	array othertaxspec [*] othertaxspec_carmrg_prf_npi1-othertaxspec_carmrg_prf_npi8;
	array primaryhcfa [*] primaryhcfa_carmrg_prf_npi1-primaryhcfa_carmrg_prf_npi8;
	array prgrpnpi [*] carmrg_prgrpnpi1-carmrg_prgrpnpi8;
	array primaryspecprg [*] primaryspec_carmrg_prgrpnpi1-primaryspec_carmrg_prgrpnpi8;
	array anyspecprg [*] anyspec_carmrg_prgrpnpi1-anyspec_carmrg_prgrpnpi8;
	array primarytaxprg [*] primarytax_carmrg_prgrpnpi1-primarytax_carmrg_prgrpnpi8;
	array othertaxspecprg [*] othertaxspec_carmrg_prgrpnpi1-othertaxspec_carmrg_prgrpnpi8;
	array primaryhcfaprg [*] primaryhcfa_carmrg_prgrpnpi1-primaryhcfa_carmrg_prgrpnpi8;	
	array hcfa [*] carmrg_hcfaspcl1-carmrg_hcfaspcl8;
...
***** Merge all together;
data addrugs.symp_specdt_all_2002_&maxyr.;
	merge ip_phyv op_phyv snf_phyv hha_phyv carmrg_phyv;
	by bene_id demdx_dt;
	drop _label_;
run;

proc contents data=addrugs.symp_specdt_all_2002_&maxyr.; run;
