...
proc sql;
	...
	from addrugs.ad_dxprv_car_2002_&maxyr. (where=(bene_id ne ""));
quit;
...
proc sql;
	...
	from addrugs.ad_dxprv_car_r2002_&maxyr. (where=(bene_id ne ""))
quit;
...
data ad_dxprv_carmrg_2002_&maxyr.;
...
proc sort data=dementia.adrd_dx_carmrg_2002_&maxyr. (where=(find(dxtypes,'A'))) out=dx_carmrg; 
	by bene_id year claim_id; 
run;

data date_test;
	merge ad_dxprv_carmrg_2002_&maxyr. (in=a rename=(demdx_dt=prvdate))
...
data addrugs.ad_dxprv_carmrg_2002_&maxyr.;
	merge ad_dxprv_carmrg_2002_&maxyr. (in=a)
...
proc contents data=addrugs.ad_dxprv_carmrg_2002_&maxyr.; run;

options obs=100;
proc print data=addrugs.ad_dxprv_carmrg_2002_&maxyr.; run;
