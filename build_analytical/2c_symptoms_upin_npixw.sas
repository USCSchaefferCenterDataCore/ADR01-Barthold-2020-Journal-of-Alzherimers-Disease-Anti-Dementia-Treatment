...
data addrugs.symp_dxprv_&ctyp.2002_&maxyr._npi;
	...
	do until (eof_samp);
		set addrugs.symp_dxprv_&ctyp.&byear._&eyear (where=(bene_id ne "")) end=eof_samp ;
...
proc freq data=addrugs.symp_dxprv_&ctyp.2002_&maxyr._npi;
	%do i=1 %to &max;
...
data upin&ctyp._ck;
	set addrugs.symp_dxprv_&ctyp.2002_&maxyr._npi;
